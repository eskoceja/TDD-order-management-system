...
//Find tests for controller:
//'OrderManagementSystem/src/test/java/com/testdrivendevelopment/OrderManagementSystem/controller/OrderControllerTest.java'

//RESTful API
//RequestMapping so I don't have to retype it after each HTTP command, unless it should have the {id}

@RestController
@RequestMapping("/api/orders")
public class OrderController {
    //bringing in the repository for it's functionality
